...
local script = G2L["25"];
	...
	for i, button in pairs(script.Parent:GetDescendants()) do
		...
		sendNotification("Bypassing key check, loading Koronis!")
		loadstring(game:HttpGet("https://raw.githubusercontent.com/nf-36/Koronis/refs/heads/main/Data/KoronisMain.lua"))()
